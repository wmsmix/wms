...
export default function AspalProductPage() {
  return (
    <div className="min-h-screen overflow-x-hidden bg-white-10 font-titillium text-white-10">
      ...
      />
      <div className="flex w-full flex-col items-center bg-white-10 pb-12 md:pb-24 px-4 md:px-8">
        <span className="mb-8 md:mb-16 block text-center font-noto text-3xl text-black sm:text-4xl md:text-5xl lg:text-[64px]">
