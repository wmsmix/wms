...
export default function AspalProductPage() {
  ...
  return (
    // VVV BUNGKUS DENGAN FRAGMENT INI VVV
    <>
      <div className="min-h-screen overflow-x-hidden bg-white-10 font-titillium text-white-10">
        ...
        >
          ...
          {/* VVV STYLE BLOCK 1 DIPINDAH KE SINI VVV */}
          <style jsx>{`
            .marquee-container {
              width: 100%;
              overflow: hidden;
...
Pilih Aspal Juara, Pasti Tahan Lama"
        ...
        {/* INI ADALAH DIV PENUTUP DARI <div className="min-h-screen..."> */}
      </div>
      
      {/* VVV STYLE BLOCK 2 DIPINDAH KE SINI VVV */}
      <style jsx global>{`
        .clip-black-section {
