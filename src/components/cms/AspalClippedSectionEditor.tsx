...
import type { AspalClippedSection } from '~/types/cms';

interface AspalClippedSectionEditorProps {
  data: AspalClippedSection;
  onChange: (data: AspalClippedSection) => void;
}

const AspalClippedSectionEditor: React.FC<AspalClippedSectionEditorProps> = ({ data, onChange }) => {
...
export default AspalClippedSectionEditor;
