...
import type { AspalHeroSection } from '~/types/cms';
import FileUploader from './FileUploader';

interface AspalHeroSectionEditorProps {
  data: AspalHeroSection;
  onChange: (data: AspalHeroSection) => void;
}

const AspalHeroSectionEditor: React.FC<AspalHeroSectionEditorProps> = ({ data, onChange }) => {
...
export default AspalHeroSectionEditor;
